...
### Reflection:
Every Saturday from January to March at 9 am and 4:30 pm, I would teach the children how to ski. We would slowly progress and get them ready for the big proper slopes using a less steeper and less longer slope for practice. After many weeks we would start going on larger slopes and a few harder ones as well. 

# Section 4: Extracurricular SciTech Experiences
Continuing with the Harvard Online course, Introduction to Artificial Intelligence with Python, I learned about the three other types of AI: Learning, Neural Network, and Language.
